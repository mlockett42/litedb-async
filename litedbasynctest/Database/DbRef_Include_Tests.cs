        ...
        */
        ...
        public async Task DbRef_Include()
        {
            ...
            using (var db = new LiteDatabaseAsync(new MemoryStream(), mapper))
            {
                ...
                await products.InsertAsync(new Product[] { product1, product2 });
                ...
                await orders.EnsureIndexAsync(x => x.Customer.Id);
                ...
                await products.DeleteAsync(product1.ProductId);
